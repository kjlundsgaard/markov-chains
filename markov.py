...
def make_text(chains):
    ...
    # initalize text by converting key bigram to the first string
    text = str(key_bigram[0]) + " " + str(key_bigram[1])
    ...
    while key_bigram in chains:
        ...
        # put text back into list to reference index for the following key
        split_text = text.split()
        # generate new key bigram from last two words of previous text
        key_bigram = (split_text[-2], split_text[-1])
